        ...
        for (int i = 0; i < Math.ceil(recordTime / 0.032); i++) {
            try{
                ...
                if (i % interSqu != 0 || i == 0){
                    ...
                    System.out.print(Arrays.toString(preparedArray));
                    interleavedArray = interleaving_VoIP.interleavingArrays(interdep, preparedArray);
                    for(int k = 0; k < 16; k++){
